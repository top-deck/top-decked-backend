...
def importar_torneios(session: SessionDep, arquivo: UploadFile, usuario: Annotated[TokenData, Depends(retornar_usuario_atual)]):
...
def deletar_torneios(session: SessionDep, usuario: Annotated[TokenData, Depends(retornar_usuario_atual)]):
